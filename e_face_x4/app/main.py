...
VERSION = os.environ.get("EFACE_VERSION", "2.21.67")
...
def create_app() -> FastAPI:
    ...
    def themed_page(filename: str, body_class: str = "") -> str:
        ...
        page = page.replace("tools-dashboard.js?v=2.21.42", "tools-dashboard.js?v=2.21.67")
        page = page.replace("tools-dashboard.css?v=2.20.36", "tools-dashboard.css?v=2.21.67")
