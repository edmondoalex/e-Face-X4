...
VERSION = os.environ.get("EFACE_VERSION", "2.21.131")
...
def create_app() -> FastAPI:
    ...
    def themed_page(filename: str, body_class: str = "") -> str:
        ...
        page = page.replace("app.css?v=2.21.84", "app.css?v=2.21.131")
        page = page.replace("home-status.css?v=2.20.20", "home-status.css?v=2.21.131")
        page = page.replace("tools.js?v=2.21.1", "tools.js?v=2.21.131")
        ...
        page = page.replace("tools-dashboard.js?v=2.21.42", "tools-dashboard.js?v=2.21.131")
        page = page.replace("tools-dashboard.css?v=2.20.36", "tools-dashboard.css?v=2.21.131")
